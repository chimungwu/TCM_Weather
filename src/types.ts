...
export const getSanYinFangGuidance = (stem: string, branch: string) => {
  const stemFormulaMap: Record<string, { name: string; ingredients: string; logic: string; mods: string }> = {
    ...
    '丙': { name: '川連茯苓湯', ingredients: '黃連、茯苓、甘草、陳皮、半夏', logic: '水運太過，寒氣盛。', mods: '熱證重加黃芩；濕重加蒼朮。' },
    '丁': { name: '蓯蓉牛膝湯', ingredients: '肉蓯蓉、牛膝、熟地、當歸、甘草', logic: '木運不及，燥金乘木。', mods: '肝血虛加當歸、熟地；燥金侵襲加桑葉。' },
    ...
    '庚': { name: '牛膝木瓜湯', ingredients: '牛膝、木瓜、熟地、當歸、肉桂、杜仲', logic: '金運太過，燥氣盛。', mods: '關節僵硬加威靈仙；肺燥明顯加麥門冬。' },
    '辛': { name: '五味子湯', ingredients: '五味子、麥門冬、人參、甘草', logic: '水運不及，燥金乘水。', mods: '眼乾加枸杞；陰虛火旺加知母、黃柏。' },
  ...
  const branchFormulaMap: Record<string, { name: string; ingredients: string; logic: string; mods: string }> = {
    '子': { name: '正陽湯', ingredients: '天麻、鉤藤、全蠍、白僵蠶、甘草', logic: '少陰君火司天。', mods: '高熱傷津加石膏；心煩不寐加梔子。' },
    '午': { name: '正陽湯', ingredients: '天麻、鉤藤、全蠍、白僵蠶、甘草', logic: '少陰君火司天。', mods: '高熱傷津加石膏；心煩不寐加梔子。' },
    '丑': { name: '備化湯', ingredients: '木瓜、茯苓、甘草、附子、乾薑、厚朴', logic: '太陰濕土司天。', mods: '下肢水腫加澤瀉；濕阻中焦加砂仁、豆蔻。' },
    '未': { name: '備化湯', ingredients: '木瓜、茯苓、甘草、附子、乾薑、厚朴', logic: '太陰濕土司天。', mods: '下肢水腫加澤瀉；濕阻中焦加砂仁、豆蔻。' },
    '寅': { name: '升明湯', ingredients: '遠志、紫菀、天門冬、甘草、白芍、山茱萸', logic: '少陽相火司天。', mods: '咽喉劇痛加射干；熱入營血加生地、丹皮。' },
    '申': { name: '升明湯', ingredients: '遠志、紫菀、天門冬、甘草、白芍、山茱萸', logic: '少陽相火司天。', mods: '咽喉劇痛加射干；熱入營血加生地、丹皮。' },
    '卯': { name: '審平湯', ingredients: '大黃、枳殼、厚朴、甘草、芒硝', logic: '陽明燥金司天。', mods: '大便秘結加大黃；皮膚乾癢加蟬蛻、荊芥。' },
    '酉': { name: '審平湯', ingredients: '大黃、枳殼、厚朴、甘草、芒硝', logic: '陽明燥金司天。', mods: '大便秘結加大黃；皮膚乾癢加蟬蛻、荊芥。' },
    '辰': { name: '靜順湯', ingredients: '羌活、獨活、防風、甘草、附子、乾薑', logic: '太陽寒水司天。', mods: '骨節痠痛加羌活、獨活；寒疝腹痛加吳茱萸。' },
    '戌': { name: '靜順湯', ingredients: '羌活、獨活、防風、甘草、附子、乾薑', logic: '太陽寒水司天。', mods: '骨節痠痛加羌活、獨活；寒疝腹痛加吳茱萸。' },
    '巳': { name: '敷和湯', ingredients: '天麻、鉤藤、全蠍、白僵蠶、甘草', logic: '厥陰風木司天。', mods: '頭暈目眩加天麻、鉤藤；風動抽搐加全蠍。' },
    '亥': { name: '敷和湯', ingredients: '天麻、鉤藤、全蠍、白僵蠶、甘草', logic: '厥陰風木司天。', mods: '頭暈目眩加天麻、鉤藤；風動抽搐加全蠍。' }
  };
